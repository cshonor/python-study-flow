...
**背诵 / 速查一页**（串联可哈希、`ChainMap`、`setdefault`、三大字典、避坑）：[`00-字典与映射-背诵速查.md`](00-字典与映射-背诵速查.md)。
...
| 顺序 | 文件 | 说明 |
|------|------|------|
| 00 | `00-字典与映射-背诵速查.md` | 一章内串联：可哈希、选型、`get`/`setdefault`、`fromkeys`、`OrderedDict`、`popitem`、PEP 584 合并、`ChainMap`；指向各篇正文 |
