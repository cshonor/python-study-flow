...
| 文件 | 说明 |
|---|---|
| `01-vector-as-sequence-intro.md` | 12.1 开篇导读：从“向量对象”到“不可变序列” |
| `02-len-and-getitem.md` | 12.2 实现 `__len__` 与 `__getitem__`：索引/切片与返回新 `Vector` |
...
```bash
python part-3-classes-and-protocols/chapter-12/vector_len_getitem_demo.py
```

或运行 v1 兼容版示例：

```bash
python part-3-classes-and-protocols/chapter-12/vector_v1_compat_demo.py
```

协议与鸭子类型示例：

```bash
python part-3-classes-and-protocols/chapter-12/protocols_duck_typing_demo.py
```
