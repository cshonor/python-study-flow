...
Usage:
  python 05_prime_spinner_gil_demo.py thread
  python 05_prime_spinner_gil_demo.py process
  python 05_prime_spinner_gil_demo.py asyncio-block
  python 05_prime_spinner_gil_demo.py asyncio-yield
  python 05_prime_spinner_gil_demo.py asyncio-exec-proc

Optional:
  python 05_prime_spinner_gil_demo.py thread 5000111000222021
"""
