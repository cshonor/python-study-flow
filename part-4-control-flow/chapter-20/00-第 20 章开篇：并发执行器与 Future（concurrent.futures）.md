...
`00_executors_and_futures_demo.py`：
...
另见 **20.2**：`02-20.2 并发网络下载：ThreadPoolExecutor 与 Future（国旗示例）.md` + `02_flags_threadpool_download_demo.py`（顺序 / 线程池 / Future 演示 / asyncio）。
