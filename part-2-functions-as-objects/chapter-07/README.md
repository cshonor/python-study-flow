...
想先快速过一遍：**`00-极简版-函数一等对象与示例7-1-7-2.md`**（一页式：核心句 + 7-1/7-2 代码与输出 + 属性表 + 运行命令）。
...
| 文件 | 说明 |
|---|---|
| `00-极简版-函数一等对象与示例7-1-7-2.md` | **一页新手版**：核心一句 + 7-1/7-2 照抄代码 + `map`/`list` + 运行命令 |
| `01-第 7 章开篇：函数作为「一等对象」是什么意思.md` | 7.x 开篇：**§零 极简背诵**（四条件 + 口诀 + 误区：一等≠高阶）+ Guido 表述与后文衔接 |
| `02-示例 7-1 7-2：函数是对象、可赋值、可传给 map（高阶函数）.md` | 7-1/7-2：速览 + **§1.3** 分条/核心结论/短句；`map`+`range(6/11)`、`is`、`callable`、属性表 |
